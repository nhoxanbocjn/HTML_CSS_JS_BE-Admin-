...
namespace TechWeb.Areas.Admin.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(DbTechContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'DbTechContext.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbTechContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
            ...
            _notyfService.Success("Đã xóa quyền truy cập");
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
