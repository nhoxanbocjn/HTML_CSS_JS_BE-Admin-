...
namespace TechWeb.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(DbTechContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            lsTrangThai.Add(new SelectListItem() { Text = "Hiệu Lực", Value = "1" });
            lsTrangThai.Add(new SelectListItem() { Text = "Vô Hiệu", Value = "0" });
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbTechContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
